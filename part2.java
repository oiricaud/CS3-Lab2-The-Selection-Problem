...
public class part2 {
	...
	//	System.out.println("");
	//	System.out.print("Current pivot: " + pivot );
		...
		intNode greaterThanPivot = quickSort(more(pivot, head.getNext()));
		// To see the procedure -- > printMe(less);
		// To see the procedure -- > System.out.println("");
		// ABOVE CALLS THE LESS METHOD //
		//System.out.println("");
	//	System.out.print("Greater sub list {");
	//	printMe(greaterThanPivot);
	//	System.out.print("}, when pivot is: " + pivot);
		...
		intNode lesserThanPivot = quickSort(less(pivot, head.getNext()));
	//	System.out.println("");
	//	System.out.print(" sub list {");
	//	printMe(lesserThanPivot);
	//	System.out.print("}, when pivot is: "	 + pivot);
		...
		numComparisons++;
		return join(join(greaterThanPivot, new intNode(pivot)), lesserThanPivot);
	...
	private static intNode join(intNode list, intNode pivot) {
	...
	//	System.out.println("");
	//	System.out.println("--->right here pivot " + pivot);
	//	System.out.println("->List here pivot " + list);
		pivot.next = list;
